...
<div className="w-full min-h-screen flex items-center justify-center bg-black">
        <div className="md:w-2/3 w-full px-4 text-white flex flex-col">
            <div className="w-full text-7xl font-bold">
                <h1 className=" w-full md:w-2/3 text-white  footer-heading">You can’t out-sneak a sneaker."
            </h1>
            </div>
            ...
            <div className="footer-text ">
                <img className='footer-image' src='/assets/extra/Footer.png' ></img>
                  <p className="footer-caption w-full md:w-2/3 text-white text-sm">To ensure that all Wikipedia content is verifiable, anyone may question an uncited claim. If your work has been tagged
                </p>
            </div>
